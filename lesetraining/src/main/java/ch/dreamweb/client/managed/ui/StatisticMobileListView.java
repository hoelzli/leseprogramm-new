...
public class StatisticMobileListView extends StatisticMobileListView_Roo_Gwt {

    private static ch.dreamweb.client.managed.ui.StatisticMobileListView instance;

    public StatisticMobileListView() {
        super("New Statistic", new CellRenderer());
        init();
    }

    public static ch.dreamweb.client.managed.ui.StatisticMobileListView instance() {
        if (instance == null) {
            instance = new StatisticMobileListView();
        }
        return instance;
    }
    ...
    private static class CellRenderer extends AbstractSafeHtmlRenderer<StatisticProxy> {
        ...
        @Override
        public SafeHtml render(StatisticProxy value) {
            if (value == null) {
