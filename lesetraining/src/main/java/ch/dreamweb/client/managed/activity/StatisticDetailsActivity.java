...
public class StatisticDetailsActivity extends StatisticDetailsActivity_Roo_Gwt {

    public StatisticDetailsActivity(EntityProxyId<ch.dreamweb.client.proxy.StatisticProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<ch.dreamweb.client.proxy.StatisticProxy> view) {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(StatisticProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((StatisticProxy) proxy);
