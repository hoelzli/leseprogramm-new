...
public class SettingDetailsActivity extends SettingDetailsActivity_Roo_Gwt {

    public SettingDetailsActivity(EntityProxyId<ch.dreamweb.client.proxy.SettingProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<ch.dreamweb.client.proxy.SettingProxy> view) {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(SettingProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((SettingProxy) proxy);
