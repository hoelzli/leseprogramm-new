...
public class SettingMobileListView extends SettingMobileListView_Roo_Gwt {

    private static ch.dreamweb.client.managed.ui.SettingMobileListView instance;

    public SettingMobileListView() {
        super("New Setting", new CellRenderer());
        init();
    }

    public static ch.dreamweb.client.managed.ui.SettingMobileListView instance() {
        if (instance == null) {
            instance = new SettingMobileListView();
        }
        return instance;
    }
    ...
    private static class CellRenderer extends AbstractSafeHtmlRenderer<SettingProxy> {
        ...
        @Override
        public SafeHtml render(SettingProxy value) {
            if (value == null) {
