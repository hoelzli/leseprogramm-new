package ch.dreamweb.client.scaffold.place;
 ...
 * {@link ch.dreamweb.client.scaffold.place.Place Place}s your app can navigate to. In
 ...
 * {@link ch.dreamweb.client.scaffold.place.ProxyListPlace ProxyListPlace}s (which show
 * all entities of a particular type) and
 * {@link ch.dreamweb.client.scaffold.place.ProxyPlace ProxyPlace}s (which give access to
